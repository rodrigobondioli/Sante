  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
        ...
        {/* MRR */}
        <div style={{ background: "var(--bg-elevated)", border: "1px solid var(--border)", borderRadius: 10, padding: "20px 22px", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", top: -30, right: -30, width: 100, height: 100, borderRadius: "50%", background: "rgba(107,79,232,0.12)", filter: "blur(30px)", pointerEvents: "none" }} />
          ...
          <p style={{ fontSize: 30, fontWeight: 800, color: "var(--accent-bright)", fontFamily: "var(--font-mono)", margin: "0 0 4px", letterSpacing: "-0.03em", lineHeight: 1 }}>
        ...
        {/* Saúde */}
        <div style={{ background: "var(--bg-elevated)", border: stats.bares_risco > 0 ? "1px solid rgba(239,68,68,0.2)" : "1px solid var(--border)", borderRadius: 10, padding: "20px 22px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
          ...
          <p style={{ fontSize: 30, fontWeight: 800, color: stats.bares_risco > 0 ? "#ef4444" : "#22c55e", fontFamily: "var(--font-mono)", margin: "0 0 8px", letterSpacing: "-0.03em", lineHeight: 1 }}>
        ...
        {/* Implantação */}
        <div style={{ background: "var(--bg-elevated)", border: stats.implantacao_abandonado > 0 ? "1px solid rgba(245,158,11,0.2)" : "1px solid var(--border)", borderRadius: 10, padding: "20px 22px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
          ...
          <p style={{ fontSize: 30, fontWeight: 800, color: "var(--fg)", fontFamily: "var(--font-mono)", margin: "0 0 8px", letterSpacing: "-0.03em", lineHeight: 1 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            {stats.implantacao_abandonado > 0 && <p style={{ fontSize: 11, color: "#f59e0b", margin: 0 }}>○ {stats.implantacao_abandonado} abandonado{stats.implantacao_abandonado !== 1 ? "s" : ""}</p>}
          </div>
        </div>

        {/* Sem uso 7d */}
        <div style={{ background: "var(--bg-elevated)", border: stats.bares_sem_uso_7d > 0 ? "1px solid rgba(245,158,11,0.25)" : "1px solid var(--border)", borderRadius: 10, padding: "20px 22px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
          ...
          <p style={{ fontSize: 36, fontWeight: 800, color: stats.bares_sem_uso_7d > 0 ? "#f59e0b" : "var(--fg-muted)", fontFamily: "var(--font-mono)", margin: "0 0 4px", letterSpacing: "-0.03em", lineHeight: 1 }}>
            {stats.bares_sem_uso_7d}
          </p>
          <p style={{ fontSize: 11, color: "var(--fg-subtle)", margin: 0 }}>
            {stats.bares_sem_uso_7d === 0 ? "todos ativos esta semana" : "inativos esta semana"}
          </p>
        </div>
